...
WebUI.click(findTestObject('Page_Master Servers  Lumina/select_field_businessPartner'))

CustomKeywords.'helper.selectOptionsHelper.selectMultipleCustomDropdown'(['100014', '100013', '100015'], true)
