...
CustomKeywords.'helper.TableHelper.ClickDetailByColumnAndValueWithPagination'('Code', 'ASUS NB')
...
WebUI.setText(findTestObject('Page_Master Business Partners  Lumina/input_field_Name Business Partner'), '100013')
...
WebUI.setText(findTestObject('Page_Master Business Partners  Lumina/input_field_Code Business Partner'), '100013')
