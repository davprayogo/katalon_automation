...
CustomKeywords.'helper.TableHelper.selectMultipleCheckboxByColumnWithPagination'('Code', ['ASUS nb'])

WebUI.click(findTestObject('General/button_Delete'))

WebUI.click(findTestObject('General/button_confirm_Delete'))

WebUI.verifyElementPresent(findTestObject('Page_Master Business Partners  Lumina/Text Notif/text_Master Business Partner deleted'), 
    5)
