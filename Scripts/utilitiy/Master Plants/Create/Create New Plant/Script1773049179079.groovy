...
WebUI.setText(findTestObject('Page_Master Plants  Lumina/textarea_field_Remarks Plant'), 'ASUS Plant')
...
WebUI.verifyElementVisible(findTestObject('Page_Master Plants  Lumina/Text Notif/text_New Master Plant created'))
