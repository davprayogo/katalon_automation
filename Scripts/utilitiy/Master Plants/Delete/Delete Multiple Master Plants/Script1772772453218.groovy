...
CustomKeywords.'helper.TableHelper.selectMultipleCheckboxByColumnWithPagination'('Code', ['ASUS1'])

WebUI.click(findTestObject('General/button_Delete'))

WebUI.click(findTestObject('General/button_confirm_Delete'))

WebUI.verifyElementPresent(findTestObject('Page_Master Plants  Lumina/Text Notif/text_Master Plant deleted'), 3)
