...
WebUI.verifyElementText(findTestObject('Page_Master Plants  Lumina/text_Master Plants'), 'Master Plants')

WebUI.verifyElementVisible(findTestObject('Page_Master Plants  Lumina/list_data_table_master_plants'))
