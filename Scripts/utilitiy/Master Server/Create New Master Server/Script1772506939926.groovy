...
WebUI.setText(findTestObject('Page_Master Servers  Lumina/input_field_name_server'), server_name)

WebUI.setText(findTestObject('Page_Master Servers  Lumina/input_field_endpoint'), endpoint)

WebUI.setText(findTestObject('Page_Master Servers  Lumina/textarea_field_remarks'), remarks)
...
WebUI.verifyElementPresent(findTestObject('Page_Master Servers  Lumina/notif_success_create_master_server'), 5)

WebUI.verifyElementText(findTestObject('Page_Master Servers  Lumina/text_New Master Server created'), 'New Master Server created')
