...
CustomKeywords.'helper.TableHelper.selectMultipleCheckboxByColumnWithPagination'('Name', ['ASUS'])

WebUI.click(findTestObject('General/button_Delete'))

WebUI.click(findTestObject('General/button_confirm_Delete'))

WebUI.verifyElementVisible(findTestObject('Page_Master Servers  Lumina/Text Notif/div_Master Server deleted'), FailureHandling.STOP_ON_FAILURE)
