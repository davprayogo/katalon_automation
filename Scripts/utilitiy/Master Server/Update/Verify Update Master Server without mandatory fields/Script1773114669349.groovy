...
CustomKeywords.'helper.TableHelper.ClickDetailByColumnAndValueWithPagination'('Name', 'ServerE')
...
WebUI.verifyElementVisible(findTestObject('General/Validation/div_This field is required'), FailureHandling.STOP_ON_FAILURE)
