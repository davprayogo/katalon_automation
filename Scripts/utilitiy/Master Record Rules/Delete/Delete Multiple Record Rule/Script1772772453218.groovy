...
CustomKeywords.'helper.TableHelper.selectMultipleCheckboxByColumnWithPagination'('Record Rule', ['Record Rule for MES'])

WebUI.click(findTestObject('General/button_Delete'))

WebUI.click(findTestObject('General/button_confirm_Delete'))

WebUI.verifyElementVisible(findTestObject('Page_Record Rules  Lumina/Text Notif/text_Record Rules deleted'), FailureHandling.STOP_ON_FAILURE)
