...
CustomKeywords.'helper.TableHelper.ClickDetailByColumnAndValueWithPagination'('Record Rule', 'dummy 20')
...
WebUI.setText(findTestObject('Page_Record Rules  Lumina/input_field_name_record_rule'), 'dummy 4')
...
WebUI.setText(findTestObject('Page_Record Rules  Lumina/input_field_rule_definition'), 'asd')
