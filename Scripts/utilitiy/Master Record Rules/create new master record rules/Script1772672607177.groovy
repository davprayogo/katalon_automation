...
WebUI.setText(findTestObject('Page_Record Rules  Lumina/input_field_name_record_rule'), 'operator record rule')
...
WebUI.setText(findTestObject('Page_Record Rules  Lumina/input_field_rule_defenition'), 'Module.Contains("MES")')

WebUI.click(findTestObject('Page_Master Group Detail  Lumina/button_Save'))
