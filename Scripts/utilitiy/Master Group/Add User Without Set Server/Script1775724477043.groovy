...
WebUI.setText(findTestObject('Object Repository/input__textfield-name-input'), 'Test')

WebUI.click(findTestObject('Object Repository/span_keyframes spin             to  transfo_73a151'))

WebUI.click(findTestObject('Object Repository/input_Indirect labor_checkbox-select_row_9-_r_1a_'))
