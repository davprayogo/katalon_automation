...
WebUI.click(findTestObject('Object Repository/input_Indirect labor_checkbox-select_row_8-_r_1f_'))

WebUI.click(findTestObject('Object Repository/button_Next'))

WebUI.click(findTestObject('Object Repository/button_Done'))

WebUI.click(findTestObject('Object Repository/input_Plant_checkbox-select_row_0-_r_1q_'))
