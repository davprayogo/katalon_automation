...
WebUI.setText(findTestObject('Object Repository/input__textfield-name-input'), 'Create and Add Notes (Test)')

WebUI.click(findTestObject('Object Repository/div_Notes'))

WebUI.setText(findTestObject('Object Repository/textarea_Create and Add Notes (Test)'), 'Create and Add Notes (Test)')
