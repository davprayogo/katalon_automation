...
WebUI.setText(findTestObject('Object Repository/input__textfield-name-input'), 'Intern 4')
...
CustomKeywords.'helper.TableHelper.selectCheckboxByColumnValue'('Groups', 'Intern')

CustomKeywords.'helper.TableHelper.selectCheckboxByColumnValue'('Groups', 'Intern 3')
