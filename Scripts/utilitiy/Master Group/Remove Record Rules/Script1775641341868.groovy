...
WebUI.click(findTestObject('Object Repository/button_login_with_sso'))
...
WebUI.click(findTestObject('Object Repository/button_Sign In and End Other Session'))

WebUI.click(findTestObject('Object Repository/button_server_dev1'))
...
WebUI.click(findTestObject('Object Repository/General/button_burger_list_menu'))
...
WebUI.click(findTestObject('Object Repository/div_Add Multiple Record Rules (Test)'))
...
WebUI.click(findTestObject('Object Repository/input_Add_checkbox-select_all-_r_13_'))

WebUI.click(findTestObject('Object Repository/span_keyframes spin             to  transfo_73a151_1'))

WebUI.click(findTestObject('Object Repository/span_Delete'))
