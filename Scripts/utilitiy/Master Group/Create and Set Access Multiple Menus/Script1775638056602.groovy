...
WebUI.setText(findTestObject('Object Repository/input__textfield-name-input'), 'Set Access Multipe Menus (Test)')

WebUI.click(findTestObject('General/div_Access Right'))

WebUI.click(findTestObject('Object Repository/button_keyframes spin             to  trans_c607ad'))

CustomKeywords.'helper.TableHelper.selectCheckboxByColumnValue'('Menu', 'Master Plants')

CustomKeywords.'helper.TableHelper.selectCheckboxByColumnValue'('Menu', 'Master Business Partners')

WebUI.click(findTestObject('Object Repository/button_Add'))

WebUI.click(findTestObject('Object Repository/input_Master Plants_checkbox-undefined-_r_1p_'))

WebUI.click(findTestObject('Object Repository/input_Master Plants_checkbox-undefined-_r_1q_'))

WebUI.click(findTestObject('Object Repository/input_Master Plants_checkbox-undefined-_r_1r_'))

WebUI.click(findTestObject('Object Repository/input_Master Plants_checkbox-undefined-_r_1s_'))

WebUI.click(findTestObject('Object Repository/input_Master Plants_checkbox-undefined-_r_1t_'))

WebUI.click(findTestObject('Object Repository/input_Master Business Partners_checkbox-und_e876db'))

WebUI.click(findTestObject('Object Repository/input_Master Business Partners_checkbox-und_65525a'))

WebUI.click(findTestObject('Object Repository/svg'))

WebUI.click(findTestObject('Object Repository/span_Approve'))

WebUI.click(findTestObject('Object Repository/span_Reject'))
