...
WebUI.click(findTestObject('button_server_dev1'))
...
WebUI.setText(findTestObject('Object Repository/input__textfield-name-input'), 'Access Rights')
...
WebUI.click(findTestObject('Object Repository/input_utilitymaster-datamaster-servers_chec_fab633'))

WebUI.click(findTestObject('Object Repository/button_Add'))

WebUI.click(findTestObject('Object Repository/button_Save'))

WebUI.click(findTestObject('Object Repository/button_Save_1'))
