...
WebUI.click(findTestObject('Object Repository/div_Set Access Multipe Menus (Test)'))

WebUI.click(findTestObject('Object Repository/button_keyframes spin             to  trans_c607ad'))

WebUI.click(findTestObject('Object Repository/div_Access Right'))

WebUI.click(findTestObject('Object Repository/input_Add_checkbox-select_all-_r_13_'))

WebUI.click(findTestObject('Object Repository/button_keyframes spin             to  trans_c607ad_1'))
