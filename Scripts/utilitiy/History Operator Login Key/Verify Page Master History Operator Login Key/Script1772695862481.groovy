...
WebUI.verifyElementText(findTestObject('Page_Operator Login QR Code  Lumina/text_Operator Login QR Code'), 'Operator Login QR Code')

WebUI.verifyElementVisible(findTestObject('Page_Operator Login QR Code  Lumina/list_data_history_operator_login_key'))
